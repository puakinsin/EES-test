...
var DashboardApps = Widget.extend({
    ...
    confirm_upgrade: function() {
        framework.redirect("https://www.elitaco.my/page/ees" + (this.data.enterprise_users || 1));
    },
});
...
var DashboardShare = Widget.extend({
    ...
    init: function(parent, data){
        this.data = data;
        this.parent = parent;
        this.share_url = 'https://www.elitaco.com/page/ees';
        this.share_text = encodeURIComponent("I am using #EES - Awesome open source business apps.");
    },
    ...
    share_linkedin: function(){
        var popup_url = _.str.sprintf('http://www.linkedin.com/shareArticle?mini=true&url=%s&title=I am using EES&summary=%s&source=www.elitaco.com', encodeURIComponent(this.share_url), this.share_text);
        this.sharer(popup_url);
    },
